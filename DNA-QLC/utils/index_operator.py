...
def connect_all(matrix, need_log=False):
    ...
    if index_binary_length%3 == 1:
        index_binary_length = index_binary_length+2
    if index_binary_length % 3 == 2:
        index_binary_length = index_binary_length + 1
    ...
    return new_matrix, index_binary_length
